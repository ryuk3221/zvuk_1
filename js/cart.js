    ...
    <div class="container">
      <div class="cart-empty__inner">
        <div class="cart-empty__content">
          <h1 class="cart-empty__title">Ваша корзина пока что пуста. Ваши товары ждут вас в каталоге</h1>
...
document.querySelectorAll('.cart-item__remover').forEach(btnRemover => {
  btnRemover.onclick = (event) => {
    ...
    if (cartItemsContainer.querySelector('.cart-item') == null) {
      ...
      document.querySelector('.cart-page').insertAdjacentHTML('beforeend', favoriteEmptyHTML)
    }
